...
/**
 * copied from commons-net class NNTPClient v3.2
 * User: Sten Martinez
 * Date: 10/15/15
 * Time: 1:28 PM
 */
public class CustomNNTPClient extends NNTP implements NewsClient {
     ...
     * @since 3.0
     */
    static NewsArticle __parseArticleEntry(String line) {
        ...
        if (parts.length > 6) {
            ...
            try {
                ...
                article.setSize(Integer.parseInt(parts[i++]));
                article.setLines(Integer.parseInt(parts[i++]));
            } catch (NumberFormatException e) {
     ...
     */
    @Override
    public Iterable<NewsArticle> iterateArticleInfo(long lowArticleNumber, long highArticleNumber)
            throws IOException
    {
