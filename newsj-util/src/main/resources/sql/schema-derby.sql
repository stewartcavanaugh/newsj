...
DROP TABLE "BinaryBlacklistEntry_SEQ";
...
CREATE TABLE "Binary_SEQ"
(
    "next_val" BIGINT DEFAULT 0 NOT NULL
);
...
CREATE TABLE "BinaryBlacklistEntry_SEQ"
(
    "next_val" BIGINT DEFAULT 0 NOT NULL
);
...
(
    ...
    "genre" VARCHAR(64),
    "country" VARCHAR(2),
    "imgdata" LONG VARCHAR FOR BIT DATA,
    "createddate" TIMESTAMP,
    PRIMARY KEY ("ID")
);
