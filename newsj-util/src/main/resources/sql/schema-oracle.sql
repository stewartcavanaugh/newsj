...
CREATE UNIQUE INDEX IX_RELEASES_ADDDATE ON RELEASES (ADDDATE);
CREATE UNIQUE INDEX IX_RELEASES_CATEGORYID ON RELEASES (CATEGORYID);
CREATE UNIQUE INDEX IX_RELEASES_GUID ON RELEASES (GUID);
CREATE UNIQUE INDEX IX_RELEASES_IMDBID ON RELEASES (IMDBID);
CREATE UNIQUE INDEX IX_RELEASES_POSTDATE ON RELEASES (POSTDATE);
CREATE UNIQUE INDEX IX_RELEASES_RAGEID ON RELEASES (RAGEID);
