...
DROP TABLE "GENERATOR_IDS" cascade constraints;
...
(NAME_ VARCHAR(255) PRIMARY KEY NOT NULL,
...
CREATE INDEX IX_BINARY_GROUPID_PROCSTAT ON BINARIES(GROUPID,PROCSTAT,"ID");
