...
<div id="page">
    ...
    <div id="content">
        <%--START PAGE CONTENT--%>
            ...
            <form action="${pageContext.request.contextPath}/admin/group-edit" method="POST">
                ...
                <table class="input">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="small" id="backfill_target" name="backfill_target" type="text" value="${group.backfillTarget}" />
